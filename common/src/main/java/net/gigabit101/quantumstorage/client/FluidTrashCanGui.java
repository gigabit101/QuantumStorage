...
public class FluidTrashCanGui extends ContainerGuiProvider<FluidTrashCanMenu> {
    private static final int WIDTH = 176;
    private static final int HEIGHT = 166;

    @Override
    public void buildGui(ModularGui gui, ContainerScreenAccess<FluidTrashCanMenu> screenAccess) {
        FluidTrashCanMenu menu = screenAccess.getMenu();
        gui.setGuiTitle(Component.translatable("gui.quantumstorage.fluid_trashcan"));
        ...
        text(root, 10, 8, 126, 10, Component.translatable("gui.quantumstorage.fluid_trashcan"), 0xFF303030);
        text(root, 10, 32, 126, 10, Component.translatable("gui.quantumstorage.fluid_trashcan_hint"), 0xFF303030);
        text(root, 8, 62, 160, 10, Component.translatable("container.inventory"), 0xFF303030);

        GuiSlots.singleSlot(root, screenAccess, menu.trashSlots, 0)
        ...
        GuiSlots.singleSlot(root, screenAccess, menu.trashSlots, 1)
