...
public class ContainerQuantumTankMk3 extends QuantumStorageContainer
{
	public TileQuantumTankMk3 tile;
	public EntityPlayer player;
	
	public ContainerQuantumTankMk3(TileQuantumTankMk3 tile, EntityPlayer player) 
	{
		super();
		this.tile = tile;
		this.player = player;
