...
public class ContainerQuantumDsuMk4 extends QuantumStorageContainer 
{
	public TileQuantumDsuMk4 tile;
	public EntityPlayer player;
	public int stackamount;

	public ContainerQuantumDsuMk4(TileQuantumDsuMk4 tilesimple, EntityPlayer player)
	{
		super();
