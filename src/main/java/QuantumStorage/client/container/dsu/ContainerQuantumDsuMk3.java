...
public class ContainerQuantumDsuMk3 extends QuantumStorageContainer 
{
	public TileQuantumDsuMk3 tile;
	public EntityPlayer player;
	public int stackamount;

	public ContainerQuantumDsuMk3(TileQuantumDsuMk3 tilesimple, EntityPlayer player)
	{
		super();
		...
		this.addSlotToContainer(new SlotFake(tilesimple.inventory, 2, 59, 42, false, false, ConfigQuantumStorage.mk3MaxStorage));
