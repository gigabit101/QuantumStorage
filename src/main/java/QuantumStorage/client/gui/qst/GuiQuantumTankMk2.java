...
public class GuiQuantumTankMk2 extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("quantumstorage", "textures/gui/dsu.png");
	private static Minecraft mc = Minecraft.getMinecraft();

	TileQuantumTankMk2 tile;
	public int amoauntStored;

	public GuiQuantumTankMk2(EntityPlayer player, TileQuantumTankMk2 tile) 
	{
		super(new ContainerQuantumTankMk2(tile, player));
		this.xSize = 176;
		this.ySize = 167;
		this.tile = tile;
	}
	...
	{
		String name = StatCollector.translateToLocal("tile.quantumtankmk2.name");
