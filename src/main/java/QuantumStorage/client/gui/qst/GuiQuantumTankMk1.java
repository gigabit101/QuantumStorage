...
public class GuiQuantumTankMk1 extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("quantumstorage", "textures/gui/dsu.png");
	private static Minecraft mc = Minecraft.getMinecraft();

	TileQuantumTankMk1 tile;
	public int amoauntStored;

	public GuiQuantumTankMk1(EntityPlayer player, TileQuantumTankMk1 tile) 
	{
		super(new ContainerQuantumTankMk1(tile, player));
		this.xSize = 176;
		this.ySize = 167;
		this.tile = tile;
	}
	...
	{
		String name = StatCollector.translateToLocal("tile.quantumtankmk1.name");
